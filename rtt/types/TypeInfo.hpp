...
{ namespace types {
    ...
    public:
        ...
        /**
         * Add a TypeId Alias to a TypeInfo so that the same Typeinfo can be
         * used for different TypeIds generated from the compiler
         * @param tid_alias the TypeId that should use this Typeinfo
         * @return true if this alias as been added properly
         */
        bool addTypeIdAlias(TypeId tid_alias);

        /**
         * Add a TypeId Alias to a TypeInfo so that the same Typeinfo can be
         * used for different TypeIds
         * @param tid_alias_name the name of the TypeId generated by the compiler
         * @return true if
         */
        bool matchTypeIdAliasName(const std::string& tid_alias_name);
    ...
    protected:
        ...
        /** Main compiler generated TypeId that uses this TypeInfo */
        TypeId mtid;
        /** Vector of the alternative compiler generated TypeId that can use
         *  this TypeInfo
         */
        std::vector<TypeId> mtidalias;
        /** The TypeId name generated by the compiler */
        const char* mtid_name;
        /** Vector of alias names that can be populated using addAlias() connectTo*/
